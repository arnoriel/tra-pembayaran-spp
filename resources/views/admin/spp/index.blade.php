            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('spp.update', $s->id)}}" method="post">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Nominal</label>
                            <input type="number"  value="{{old('nominal', $s->nominal)}}" class="form-control @error('nominal')
                            is-invalid
                            @enderror" name="nominal" placeholder="Masukkan Nama Kompetensi dengan Benar">
    ...
    <div class="modal fade" id="delete{{$s->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <p>Apakah anda yakin ingin mengahpus data <b>{{$s->tahun}}</b>?</p>
                </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
